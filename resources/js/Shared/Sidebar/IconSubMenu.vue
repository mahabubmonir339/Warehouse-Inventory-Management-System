<template>
  <div class="z-10 flex group relative">
    <a
      ...
      class="cursor-pointer flex items-center justify-center border-b w-16 h-12 border-darker px-2 lg:px-4 focus:bg-orange-600 hover:bg-orange-700 group-hover:bg-orange-600"
    >
    ...
    <div class="z-50 rounded-br absolute inset-x-full top-0 hidden group-hover:flex w-56 flex-wrap">
      <div class="bg-orange-600 h-12 w-56 flex items-center border-b border-darker rounded-tr px-2 lg:px-4">
        <slot></slot>
      </div>
