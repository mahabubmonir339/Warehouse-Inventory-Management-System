const menus = [
...

  {
    ...
    heading: null,
    children: ['rfid'],
    lang: { helper: null, main: 'RFID Module' },
    permissions: ['view-rfid-live', 'view-rfid-tags', 'view-rfid-readers'],
    sub_menu: [
      {
        name: 'rfid.live',
        route: 'rfid.live',
        ...
        sub_menu: false,
        target: 'rfid',
        permissions: ['view-rfid-live'],
        lang: { main: 'Live Monitor' },
      },
      {
        name: 'rfid.assign',
        route: 'rfid.assign',
        ...
        sub_menu: false,
        target: 'rfid',
        permissions: ['assign-rfid-tags'],
        lang: { main: 'Assign Tags' },
      },
      {
        name: 'rfid.logs',
        route: 'rfid.logs',
        ...
        sub_menu: false,
        target: 'rfid',
        permissions: ['view-rfid-logs'],
        lang: { main: 'Scan History' },
      },
      {
        name: 'rfid.tags',
        route: 'rfid.tags',
        ...
        sub_menu: false,
        target: 'rfid',
        permissions: ['view-rfid-tags'],
        lang: { main: 'Manage Tags' },
      },
      {
        name: 'rfid.readers',
        route: 'rfid.readers',
        ...
        sub_menu: false,
        target: 'rfid',
        permissions: ['view-rfid-readers'],
        lang: { main: 'Manage Readers' },
      },
    ],
  },
